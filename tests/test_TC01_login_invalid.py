...
class TestLoginInvalid:
    ...
    def test_TC01_login_invalid(self, driver, username, password, expected_error_message):
        ...
        assert txt_username_error == expected_error_message, "Error message is not as expected"
